        ...
        <div class="mt-4">
            <label for="terms" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600">
                    I agree to the <a href="/terms" class="underline text-indigo-600 hover:text-indigo-900" target="_blank">Terms of Service</a> and <a href="/privacy" class="underline text-indigo-600 hover:text-indigo-900" target="_blank">Privacy Policy</a>
                </span>
            </label>
